...
import { GeminiModelId, ModelConfig } from './types';

export const MODELS: Record<string, ModelConfig> = {
  [GeminiModelId.FLASH]: {
    modelId: GeminiModelId.FLASH,
    name: 'Gemini 2.5 Flash',
    description: 'Rápido, multimodal e eficiente.',
    supportsImages: true,
    supportsThinking: true,
    maxThinkingBudget: 24576
  },
  [GeminiModelId.PRO]: {
    modelId: GeminiModelId.PRO,
    name: 'Gemini 3.0 Pro',
    description: 'Raciocínio de alto nível e tarefas complexas.',
    supportsImages: true,
    supportsThinking: true, // Pro Preview supports thinking
    maxThinkingBudget: 32768
  },
  [GeminiModelId.FLASH_LITE]: {
    modelId: GeminiModelId.FLASH_LITE,
    name: 'Gemini Flash Lite',
    description: 'Custo-benefício para tarefas simples.',
    supportsImages: true,
    supportsThinking: true,
    maxThinkingBudget: 24576
  }
...
export const IconBrain = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"/><path d="M15 13a4.5 4.5 0 0 1-3-1.4 4.5 4.5 0 0 1-3 1.4A5 5 0 0 1 15 13Z"/></svg>
);
