...
const ScrollExpandMedia = ({
  ...
  useEffect(() => {
    const handleWheel = (e: WheelEvent) => {
      // Safety check for scroll behavior
    ...
    // Use try-catch for adding event listeners to be safe
    try {
  ...
  const isYouTube = mediaSrc.includes('youtube') || mediaSrc.includes('youtu.be');

  // If motion is not available, render a fallback div?
  // We assume motion is available via import.
